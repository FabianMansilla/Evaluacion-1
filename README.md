    ...
    <div class="container">
      <div class="row">
        <div class="col-12 mt-5">
          ...
          <p class="lead">2022-hasta que me muera</p>
    ...
    <div class="container">
      <div class="row">
        <div class="my-3 col-lg-4 col-md-4">
          <h3>Acepte a Cristo y mis correos</h3>
          <form>
            <fieldset class="form-group my-3">
              <input type="email" class="form-control" id="Input Email" placeholder="Email"> </fieldset>
            <button type="submit" class="btn btn-outline-primary" contenteditable="true">Deme su Alma aqui</button>
          </form>
        </div>
